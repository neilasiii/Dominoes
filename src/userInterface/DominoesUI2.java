...
public class DominoesUI2 extends JFrame {

	public static void main(String[] args) {
		DominoesUI2 frame = new DominoesUI2();
	...
	private void initComponents() {
		...
		gamePanel.setMinimumSize(new Dimension(950,800));
		gamePanel.setMaximumSize(new Dimension(950,800));
		gamePanel.setPreferredSize(new Dimension(950,800));	
		...
		playerHandPanel.setMinimumSize(new Dimension(950,175));
		playerHandPanel.setMaximumSize(new Dimension(950,175));
		playerHandPanel.setPreferredSize(new Dimension(950,175));
		...
		for (int i = 0; i < 7; i++) {
			...
			playerHandPanel.add(playerHandButtons[i], BorderLayout.CENTER);
		}
